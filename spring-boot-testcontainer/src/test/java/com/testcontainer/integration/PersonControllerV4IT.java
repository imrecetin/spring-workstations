...
@ContextConfiguration(initializers = PersonControllerV4IT.Initializer.class)
public class PersonControllerV4IT {
    ...
    public void testNotExistingPersonByIdShouldReturn404() {
        ResponseEntity<Person> result = testRestTemplate.getForEntity("/api/person/42", Person.class);
    ...
    public void testExistingPersonById() {
        ...
        ResponseEntity<Person> result = testRestTemplate.getForEntity("/api/person/1", Person.class);
